...
export function mergeMovementWithContext(
  ...
  return {
    ...
    issueDate: pickText(order.issueDate, cachedDraft?.issueDate, order.occurredDate, cachedDraft?.occurredDate),
    issueSku: pickText(order.issueSku, cachedDraft?.issueSku, order.itemSku, order.sku),
    issueProductName: pickText(order.issueProductName, cachedDraft?.issueProductName, order.productName),
    issueQtyPiece: pickNumber(order.issueQtyPiece, cachedDraft?.issueQtyPiece, order.qtyPiece),
    returnDate: pickText(order.returnDate, cachedDraft?.returnDate, order.occurredDate, cachedDraft?.occurredDate),
    returnSku: pickText(order.returnSku, cachedDraft?.returnSku, order.itemSku, order.sku),
    returnProductName: pickText(order.returnProductName, cachedDraft?.returnProductName, order.productName),
    returnQtyPiece: pickNumber(order.returnQtyPiece, cachedDraft?.returnQtyPiece, order.qtyPiece),
